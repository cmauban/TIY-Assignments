...
//
// also, in the HTML there is not a div id attribute that included style
// anymore. the script tags.
//
...
// to get the drop down information. (need to add a class attribute to the list element)
//
